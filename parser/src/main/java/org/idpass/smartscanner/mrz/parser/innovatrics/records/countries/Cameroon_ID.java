...
/**
 * Format used for Cameroon ID Cards.
 * Subset of MrtdTd1 format
 */
public class Cameroon_ID extends MrzRecord {
    private static final long serialVersionUID = 1L;

    public Cameroon_ID() {
        super(MrzFormat.CAMEROON_ID);
    }
    /**
    ...
    public String toString() {
        return "CAMEROON-ID{" + super.toString() + ", optional=" + optional + ", optional2=" + optional2 + '}';
    }
