...
/**
 * Format used for Burkina ID Cards.
 * Subset of MrtdTd1 format
 */
public class Burkina_ID extends MrzRecord {
    private static final long serialVersionUID = 1L;

    public Burkina_ID() {
        super(MrzFormat.BURKINA_ID);
    }
    /**
    ...
    public String toString() {
        return "BFA{" + super.toString() + ", optional=" + optional + ", optional2=" + optional2 + '}';
    }
