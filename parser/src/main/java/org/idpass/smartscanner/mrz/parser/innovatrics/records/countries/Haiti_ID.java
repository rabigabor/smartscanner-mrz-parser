...
/**
 * Format used for Haiti ID Cards.
 * Subset of MrtdTd1 format
 */
public class Haiti_ID extends MrzRecord {
    private static final long serialVersionUID = 1L;

    public Haiti_ID() {
        super(MrzFormat.HAITI_ID);
    }
    /**
    ...
    public String toString() {
        return "HTI{" + super.toString() + ", optional=" + optional + ", optional2=" + optional2 + '}';
    }
