...
/**
 * Format used for Iraq ID Cards.
 * Subset of MrtdTd1 format
 */
public class Iraq_ID extends MrzRecord {
    private static final long serialVersionUID = 1L;

    public Iraq_ID() {
        super(MrzFormat.IRAQ_ID);
    }
    /**
    ...
    public String toString() {
        return "IRQ-ID{" + super.toString() + ", optional=" + optional + ", optional2=" + optional2 + '}';
    }
