...
/**
 * Format used for Pakistan ID Cards.
 * Subset of MrtdTd1 format
 */
public class Pakistan_ID extends MrzRecord {
    private static final long serialVersionUID = 1L;

    public Pakistan_ID() {
        super(MrzFormat.PAKISTAN_ID);
    }
    /**
    ...
    public String toString() {
        return "PAK-ID{" + super.toString() + ", optional=" + optional + ", optional2=" + optional2 + '}';
    }
